function ui_study_stats_window(study_data, template_name)
    ...
    uicontrol(button_panel, 'Style','pushbutton', 'String','Экспорт средних данных', ...
        'Units','normalized', 'Position',[0.35, 0.1, 0.28, 0.8], ...
        'Callback', {@(~,~) logic_export_study_stats(fig, template_name)});
    uicontrol(button_panel, 'Style','pushbutton', 'String','Экспорт индивидуальных данных', ...
        'Units','normalized', 'Position',[0.65, 0.1, 0.28, 0.8], ...
        'Callback', {@(~,~) logic_export_individual_stats(fig, template_name)});
